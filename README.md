...
Testnet
```
forge create --rpc-url https://public-en.kairos.node.kaia.io --private-key $pvky src/Counter.sol:Counter --constructor-args 5
```

Mainnet
```
forge create --rpc-url https://public-en.node.kaia.io --private-key $pvky src/Counter.sol:Counter --constructor-args 5
```
